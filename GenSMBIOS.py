...
class Smbios:
    ...
    def _generate_smbios(self, macserial):
        ...
        for i in range(10000):
            smbios = self._get_smbios(macserial,"MacBookPro16,1",times)
            if smbios == None:
                # Issues generating
            ...
            a = ":{}:{}:{}:{}:{}:".format(smbios[0][4].lower(), smbios[0][2], smbios[0][1] ,"Mac-E1008331FDC96864","MacBookPro16,1")
            
        
            with open('5ma.txt', 'a') as f:
                f.write(a)
                f.write('\n')
